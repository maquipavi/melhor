...
api_key = st.sidebar.text_input(
    "Google API Key", 
    value="AIzaSyBarB5CfRsl_M0nkQjgg-ystWV-CyzN0jU",
    type="password", 
    help="Digite sua chave da API do Google Gemini"
)
...
def main():
    ...
    with col1:
        data_nascimento = st.date_input(
            ...
            help="Escolha sua data de nascimento para análise",
            min_value=date(1900, 1, 1),  # Data mínima: 01/01/1900
    ...
    if iniciar_analise and data_nascimento:
